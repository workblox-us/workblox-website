      ...
      <Container maxWidth='lg' sx={{ position: 'relative', zIndex: 1 }}>
        ...
        >
          ...
          >
            ...
            <Typography
              variant='caption'
              sx={{ color: colors.isDark ? '#a5b4fc' : '#6366f1' }}
            >
              Knowledge Hub
            </Typography>
          </Box>
          ...
          >
            Product updates, guides, and insights to help you get the most out
            of Workblox
          </Typography>
        </Box>
          ...
          >
            ...
            >
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5 }}>
                <FilterList
                  sx={{ fontSize: '1.25rem', color: colors.text.primary }}
                />
                <Typography
              ...
              {hasActiveFilters && (
                <Chip
                  label='Clear all'
                  size='small'
                  icon={<Close sx={{ fontSize: '0.875rem' }} />}
        ...
        {filteredArticles.length === 0 && (
          ...
          >
            ...
            />
            <Typography
              sx={{ color: colors.text.primary, fontSize: '1.25rem', mb: 1 }}
            >
              No articles found
            </Typography>
